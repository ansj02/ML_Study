...
hidden2_1 = Dense(32, activation='elu')(X2)
hidden2_2 = Dense(15, activation='elu')(hidden2_1)
hidden2_3 = Dense(8, activation='elu')(hidden2_2)
Qpred2 = Dense(output_size, activation='elu')(hidden2_1)
targetmodel = Model(X2,Qpred2)

model.compile(loss='mse', optimizer='adam', metrics=['accuracy'])
targetmodel.compile(loss='mse', optimizer='adam', metrics=['accuracy'])
        ...
        for _ in range(50):
            ...
            for state, action, reward, next_state, done in minibatch:
                ...
                if done:
                    ...
                    Q[0, action] = reward + dis*np.max(targetmodel.predict(np.reshape(next_state, [1, input_size])))
