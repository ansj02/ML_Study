...
#model.add(Dense(100, activation='elu', input_dim=n))tanh
model.add(LSTM(500, activation='tanh', input_shape=(n,1), return_sequences=True))
...
model.compile(loss='mae', optimizer='sgd', metrics=['acc'])
