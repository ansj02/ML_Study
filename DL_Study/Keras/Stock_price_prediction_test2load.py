...
model = load_model('testTrainingData.h5')
'''
...
model.fit(x_train, y_train, epochs=215, batch_size=1, validation_data=(x_val, y_val), callbacks = [early_stopping])
...
model.save('testTrainingData.h5')